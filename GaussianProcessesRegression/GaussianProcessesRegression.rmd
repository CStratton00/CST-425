...
seqdata <- read.delim("/Users/collinstratton/Google Drive/School/GCU/Fall 2021 - Spring 2022/CST-425/CST-425/GaussianProcessesRegression/GSE60450_LactationGenewiseCounts.txt", stringsAsFactors = FALSE)
# Read the sample information into R
sampleinfo <- read.delim("/Users/collinstratton/Google Drive/School/GCU/Fall 2021 - Spring 2022/CST-425/CST-425/GaussianProcessesRegression/SampleInfo.txt", stringsAsFactors = TRUE)
...
n <- 10
x <- matrix(seq(0,1,length.out = n), ncol=1)
y <- dglist$counts[1:10,1]

#doesnt work
#trainmodel <- dglist$counts[1:100,1]
#y <- lm(counts,data=trainmodel)
#y
...
## Covariance Function
Covariance models of RNA sequences are extremely sensitive and discriminative tool for searching for additional RNAs and RNA-related sequences in sequence databases. Models can be built automatically from an existing sequence alignment.
