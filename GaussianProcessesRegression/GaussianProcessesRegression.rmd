...
x_train <- matrix(seq(0,1,length.out = 35), ncol=1)
x_test <- matrix(seq(0,1,length.out = 15), ncol=1)
...
confusion_matrix <- table(y_test, predicted)
confusion_matrix

# State accuracy and error rate
accuracy <- sum(diag(confusion_matrix)) / nrow(y_test)
