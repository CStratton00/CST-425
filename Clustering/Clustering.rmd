...
To resolve these issues, we used Excel with a new
...
LHS <- apriori(associationdf, parameter=list(support=0.0005, confidence=0.9), appearance=list(rhs=c("JUMBO BAG RED RETROSPOT"), default="lhs"))
#summary(LHSrules)
LHSbylift <- sort(LHS, by="lift", decreasing=TRUE)
...
# Visual Results using arulesViz
