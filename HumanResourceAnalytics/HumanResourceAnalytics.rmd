...
model <- lm(data$HourlyRate~., data = train,scale = TRUE)
#pcr_pred <- predict(model,test,ncomp=3)
#plot(data$HourlyRate, col="green", type="l", lty=1, lwd=5, main = "Actual vs Predicted Values")
#lines(pcr_pred, col="red", type="l", lty=1, lwd=2.5)


#pca6Components$values
#pca6Components$x
#typeof(pca3Components)
#pcaComponentsLinear <- as.data.frame(pca6Components$values)
#pcaComponentsLinear
#typeof(pca3Components)
#nrow(data$HourlyRate)
#nrow(pcaComponentsLinear)
