...
The accuracy of our model is 99.8% with a seed of 1234. The confusion matrix shows a perfect prediction accuracy for detecting actual non-spam emails, while the prediction of actual spam emails is nearly perfect with an accuracy of 472/474. Overall, the testing set shows that the model has high accuracy in predicting spam emails.
...
The accuracy of this prediction is 44.1% with a seed of 1234. The confusion matrix shows a perfect prediction accuracy for detecting actual non-spam emails. However, the prediction accuracy for actual spam emails is low with an accuracy of 433/1889. However, notice that the ratio of non-spam to spam emails in the model training set is about 35%/65%, whereas this model is the opposite with 35%/65%. This may result in a skew of the data due to the difference in the expected ratio. Thus, this method of verifying the model is inconclusive.
